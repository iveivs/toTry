...
list.addEventListener('click', (e) => {
    if(e.target.classList.contains('list-style')){
        ...
        // if(e.target.firstElementChild.classList.contains('list-hidden')) {
        //     e.target.firstChild.textContent = 'less info...'
        // }
        if(e.target.firstElementChild.classList.contains('list-hidden')) {
            e.target.firstElementChild.classList.remove('list-hidden')
            e.target.firstChild.textContent = 'less info...'
        } else {
            e.target.firstElementChild.classList.add('list-hidden')
            e.target.firstChild.textContent = 'less info...'
        }
