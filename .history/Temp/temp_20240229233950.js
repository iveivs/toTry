...
function calculator(string) {
    const romanian = ['I', 'II', 'III', 'IV', 'V', 'VI', 'VII', 'VIII', 'IX', 
                    'X', 'XI', 'XII', 'XIII', 'XIV', 'XV', 'XVI', 'XVII', 'XVIII', 'XVIX', 
                    'XX', 'XXI', 'XXII', 'XXIII', 'XXIV', 'XXV', 'XXVI', 'XXVII', 'XXVIII', 'XXVIX', 
                    'XXX', 'XXXI', 'XXXII', 'XXXIII', 'XXXIV', 'XXXV', 'XXXVI', 'XXXVII', 'XXXVIII', 'XXXVIX',
                    'XL', 'XLI', 'XLII', 'XLIII', 'XLIV', 'XLV', 'XLVI', 'XLVII', 'XLVIII', 'XLIX', 'XLIX',
                    'L', 'LI', 'LII', 'LIII', 'LIV', 'LV', 'LVI', 'LVII', 'LVIII', 'LIX',
                    'LX', 'LXI', 'LXII', 'LXIII', 'LXV', 'LXVI', 'LXVII', 'LXVIII', 'LXIX',
                    'LXX', 'LXXI', 'LXXII', 'LXXIII', 'LXXV', 'LXXVI', 'LXXVII', 'LXXVIII', 'LXXIX',
                    'LXXX', 'LXXXI', 'LXXXII', 'LXXXIII', 'LXXXV', 'LXXXVI', 'LXXXVII', 'LXXXVIII', 'LXXXIX',
                    'XC', 'XCI', 'XCII', 'XCIII', 'XCIV', 'XCV', 'XCVI', 'XCVII', 'XCVIII', 'IX', 
                    ]
